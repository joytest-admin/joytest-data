...
/**
 * GET /api/exports/test-results/by-interval
 * Export test results by time interval as CSV
...
export async function GET(request: NextRequest) {
  try {
    ...
    const url = `${baseUrl}/api/exports/test-results/by-interval?${queryParams.toString()}`;
