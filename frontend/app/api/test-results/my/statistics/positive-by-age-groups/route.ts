/**
 * Next.js API route for getting positive test statistics by age groups
...
export async function GET(request: NextRequest) {
  try {
    ...
    const response = await backendGet<ApiResponse<{ age0to5: number; age6to14: number; age15to24: number; age25to64: number; age65plus: number }>>(
      `/api/test-results/my/statistics/positive-by-age-groups?${queryParams.toString()}`,
      undefined,
