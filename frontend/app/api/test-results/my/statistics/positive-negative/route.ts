/**
 * Next.js API route for getting positive/negative test result statistics
...
export async function GET(request: NextRequest) {
  try {
    ...
    const response = await backendGet<ApiResponse<{ positive: number; negative: number }>>(
      `/api/test-results/my/statistics/positive-negative?${queryParams.toString()}`,
      undefined,
