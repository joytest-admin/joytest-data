/**
 * Next.js API route for getting positive test trends by pathogens over time
...
export async function GET(request: NextRequest) {
  try {
    ...
    const response = await backendGet<ApiResponse<{ byPathogen: Array<{ date: string; pathogenName: string; count: number }>; total: Array<{ date: string; count: number }> }>>(
      `/api/test-results/my/statistics/positive-trends-by-pathogens?${queryParams.toString()}`,
      undefined,
